...
{
    Task<Batch> CreateAsync(Guid workspaceId, string name, string branchName, string baseBranch, string worktreePath, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<Batch>> ListAsync(Guid workspaceId, CancellationToken cancellationToken = default);
    Task<Batch> TransitionToWorkingAsync(Guid batchId, CancellationToken cancellationToken = default);
    Task<Batch> SetStoppedAtAsync(Guid batchId, DateTimeOffset? value, CancellationToken cancellationToken = default);
    Task<Batch> SetFinishedAtAsync(Guid batchId, DateTimeOffset? value, CancellationToken cancellationToken = default);
    ...
    Task<Batch> RenameAsync(Guid batchId, string newName, CancellationToken cancellationToken = default);
