...
public interface IGitCli
{
    ...
    Task<PushResult> PushWithSetUpstreamAsync(string workspacePath, CancellationToken cancellationToken = default);
    ...
    Task<bool> IsBranchMergedIntoAsync(string workspacePath, string branchName, string baseBranch, CancellationToken cancellationToken = default);
    ...
    Task<MergeResult> MergeAsync(string workspacePath, string branchName, CancellationToken cancellationToken = default);
}
