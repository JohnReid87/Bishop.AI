...
public sealed class DeadCodeContextProviderTests
{
    private readonly DeadCodeContextProvider _sut = new();

    [Fact]
    public void SkillName_IsDeadCode()
    {
        _sut.SkillName.Should().Be("dead-code");
    }
